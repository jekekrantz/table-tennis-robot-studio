...
- Run: connect the robot, review the selected drill and robot pose, set repetitions and set delay, play/stop, and use live tuning while a drill runs.
...
- Robot: connect/disconnect Nova, inspect status and diagnostics, open calibration, and configure idle STOP and BLE-disconnect timers. Idle STOP leaves BLE connected for a quick re-initialization; BLE disconnect releases the radio and requires reconnecting later.
