...
const helpRequest=Core.buildExternalAiRequest({userRequest:'How do I calibrate?',requestKind:'help',appContext:{screen:'Robot',activeDrill:'Warm-up',drillSource:'Built-in',selection:null,secret:'do not include'}});
